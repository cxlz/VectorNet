...
if __name__ == '__main__':
    ...
    #    work(path + name,name, '') 
    path = '/datastore/data/cxl/argoverse/val/data'
    save_path = 'data/origin/test_data/'
    ...
    for name in nameList:
       work(os.path.join(path, name),name, save_path)
		
    path = '/datastore/data/cxl/argoverse/train/data'
    save_path = 'data/origin/train_data/'
    if not os.path.exists(save_path):
        os.makedirs(save_path)
